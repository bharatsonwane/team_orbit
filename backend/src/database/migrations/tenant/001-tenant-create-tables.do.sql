...
CREATE TABLE IF NOT EXISTS chat_channel (
    ...
    -- ENUM for chat channel type
    description TEXT,
    -- Chat channel description
    image VARCHAR(255),
    -- Image URL for the chat channel
    "createdAt" TIMESTAMP DEFAULT NOW() NOT NULL,
    "updatedAt" TIMESTAMP DEFAULT NOW() NOT NULL,
...
CREATE TABLE IF NOT EXISTS chat_channel_user_mapping (
    ...
    -- Foreign key to chat_channel table
    "userId" INT NOT NULL,
    -- Foreign key to user table
    "isAdmin" BOOLEAN DEFAULT FALSE NOT NULL,
    -- Indicates if the user is an admin in the chat channel
    "isActive" BOOLEAN DEFAULT TRUE NOT NULL,
    -- Indicates if the mapping is active
    "createdAt" TIMESTAMP DEFAULT NOW() NOT NULL,
    "updatedAt" TIMESTAMP DEFAULT NOW() NOT NULL,
...
CREATE TABLE IF NOT EXISTS chat_message (
    ...
    -- Indicates if the message is edited
    "isDeleted" BOOLEAN DEFAULT FALSE NOT NULL,
    -- Indicates if the message is deleted
    "deliveredTo" JSON,
    -- JSON array storing who the message is delivered to
    "readBy" JSON,
    -- JSON array storing who has read the message
    reaction JSON,
    -- JSON storing reactions to the message
    "chatChannelId" INT NOT NULL,
    -- Foreign key to chat_channel table
