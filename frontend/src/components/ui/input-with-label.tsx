...
type InputWithLabelComponentProps = InputWithLabelProps | TextareaWithLabelProps;
...
export const SelectWithLabel = forwardRef<HTMLSelectElement, SelectWithLabelProps>(
  ({ id, label, required = false, error, helperText, className, inputClassName, disabled = false, register, children, ...props }) => {
    const containerClasses = cn('space-y-2', className);
    const labelClasses = cn(
      'text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70'
    );
