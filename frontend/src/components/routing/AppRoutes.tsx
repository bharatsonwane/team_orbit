...
import Employees from "@/pages/platform/tenant/Employees";
    ...
    childItems: [
      {
        ...
        isShownInSidebar: true,
        icon: Users,
        href: "/tenant/:tenantId/employees",
        path: "/tenant/:tenantId/employees",
        allowedRoles: [userRoleKeys.ANY],
        element: <Employees />,
        description: "Browse and manage all employees in your organization",
      },
      {
        title: "Departments",
        isShownInSidebar: true,
