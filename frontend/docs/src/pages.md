...
- **`tenant/`** - Tenant-specific pages (Home, Employees, Notifications)
...
│   │   ├── Employees.tsx         # Tenant employee management
│   │   └── components/
...
**Location**: `src/pages/platform/tenant/Employees.tsx`  
**Route**: `/platform/tenant/:tenantId/employees`  
**Access**: Protected (Platform Admin roles)  
**Purpose**: Manage tenant employees

### Features

- List all employees for a specific tenant
- Add new employees to tenant
- Edit existing employee information
- Employee role management (TENANT_ADMIN, TENANT_MANAGER, TENANT_USER)
- Status filtering
- Reuses `AddUserModal` and `EditUserModal` components
